...
import { createReactComponent } from './react-component-lib';\n`;
  ...
  if (outputTarget.includeImportCustomElements && outputTarget.componentCorePackage !== undefined) {
    const cmpImports = components.map(component => {
      ...
      return `import { ${pascalImport} as ${pascalImport}Cmp,
      
      defineCustomElement as defineCustomElement${pascalImport}
    
    } from '${normalizePath(outputTarget.componentCorePackage!)}/${outputTarget.customElementsDir ||
        'components'
